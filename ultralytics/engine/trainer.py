...
class BaseTrainer:
    ...
    def _setup_train(self, world_size):
        ...
        # Pre-initialize criterion so any trainable loss modules (e.g. InterScaleConsistencyLoss)
        # are registered on the model before DDP wrapping and optimizer construction
